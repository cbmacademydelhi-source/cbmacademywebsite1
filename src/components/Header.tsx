...
export const Header: React.FC<HeaderProps> = ({ onOpenApply, onOpenBrochure }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'course', 'why-cbm', 'ai-tools', 'jobs', 'certificate', 'blogs', 'about', 'contact'];
  ...
  const navLinks = [
    ...
    { name: 'Certificate Verification', href: '#certificate', id: 'certificate' },
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
          <div className="flex items-center gap-2 font-medium">
            <span className="inline-flex items-center gap-1 bg-[#FF6B00] text-white px-2 py-0.5 rounded text-[11px] font-semibold tracking-wide uppercase">
              <Sparkles className="w-3 h-3" /> New Batch
            </span>
            <span>New Batch Starting Soon &bull; Limited 25 Seats</span>
          </div>
          <div className="flex items-center gap-4 text-slate-200">
            <a href="tel:+919876543210" className="inline-flex items-center gap-1.5 hover:text-[#FF6B00] transition-colors">
      ...
      <header
        ...
        className={`sticky top-0 z-40 w-full transition-all duration-200 bg-white/95 backdrop-blur-md border-b ${
          isScrolled ? 'border-slate-200 shadow-md py-2' : 'border-slate-100 py-3'
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
          {/* Left: Exact Official CBM Academy Logo */}
          <a
            href="#home"
          ...
          >
            <CbmLogo height={isScrolled ? 42 : 48} showTagline={true} />
          </a>
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <button
              ...
              id="header-apply-btn"
              type="button"
              className="inline-flex items-center justify-center gap-2 bg-[#FF6B00] hover:bg-[#e05e00] text-white font-bold text-sm px-5 py-2.5 rounded-xl shadow-sm hover:shadow-md transition-all duration-150 cursor-pointer active:scale-98 focus:outline-none focus:ring-2 focus:ring-[#FF6B00] focus:ring-offset-2"
            >
              <span>Apply Now</span>
        ...
        {mobileMenuOpen && (
          <div
            ...
            className="lg:hidden border-t border-slate-200 bg-white px-4 pt-3 pb-6 space-y-2 shadow-xl animate-in slide-in-from-top duration-200"
          >
