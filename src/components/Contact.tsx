...
export const Contact: React.FC = () => {
  ...
  return (
    <section
      id="contact"
      className="relative overflow-hidden pt-12 sm:pt-16 pb-12 sm:pb-16 bg-[#FAFAFA] border-b border-slate-100"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 mb-8 sm:mb-10">
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#FF6B00]/15 text-[#FF6B00] text-xs font-bold uppercase tracking-wider border border-[#FF6B00]/30 shadow-2xs"
          >
            Get In Touch
          </motion.div>
          <motion.h2
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          >
            ...
            <div className="bg-white p-6 sm:p-8 rounded-[20px] border border-orange-200/80 shadow-[0_4px_20px_rgba(0,0,0,0.04)] space-y-6">
              
              <h3 className="text-xl font-bold text-[#072B57] pb-3 border-b border-slate-100">
                Admissions & Campus Office
              </h3>

              {/* Address */}
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-orange-50 border border-orange-100 flex items-center justify-center flex-shrink-0 text-[#FF6B00] shadow-2xs">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-0.5">Official Email</h4>
                  <a
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-0.5">Helpline & WhatsApp</h4>
                  <a
            ...
            <div className="rounded-[20px] overflow-hidden border border-orange-200/80 shadow-sm bg-white h-56 relative">
              <iframe
          ...
          >
            {/* White Card Container */}
            <div className="bg-white p-6 sm:p-8 rounded-[20px] border border-orange-200/80 shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
              ...
              <div className="mb-6">
                ...
                <p className="text-xs sm:text-sm text-slate-600 mt-1">
                  All messages are routed directly to <strong className="text-[#FF6B00]">office@cbmacademy.in</strong>. We reply within 24 hours.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${
                        errors.fullName ? 'border-rose-400 ring-1 ring-rose-400 bg-rose-50' : 'bg-slate-50 border-slate-200 focus:bg-white focus:ring-[#FF6B00] focus:border-transparent'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${
                        errors.email ? 'border-rose-400 ring-1 ring-rose-400 bg-rose-50' : 'bg-slate-50 border-slate-200 focus:bg-white focus:ring-[#FF6B00] focus:border-transparent'
                      }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${
                        errors.phone ? 'border-rose-400 ring-1 ring-rose-400 bg-rose-50' : 'bg-slate-50 border-slate-200 focus:bg-white focus:ring-[#FF6B00] focus:border-transparent'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-sm text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#FF6B00] focus:border-transparent"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 rounded-xl border text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${
                      errors.message ? 'border-rose-400 ring-1 ring-rose-400 bg-rose-50' : 'bg-slate-50 border-slate-200 focus:bg-white focus:ring-[#FF6B00] focus:border-transparent'
                    }`}
                  />
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 bg-[#FF6B00] hover:bg-[#e05f00] text-white font-bold text-base py-3.5 rounded-xl shadow-md hover:shadow-lg transition-all active:scale-98 disabled:opacity-60 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#FF6B00] focus:ring-offset-2 focus:ring-offset-white"
                >
                  {isSubmitting ? (
                    <>
