...
export const Header: React.FC<HeaderProps> = ({
  ...
  const navLinks = [
    ...
    { name: 'Webinars', href: '#webinars', id: 'webinars' },
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-[#072B57] text-white text-xs py-2 px-4"
      >
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
          ...
          <div className="flex items-center gap-4 text-blue-200">
            ...
            <span className="hidden md:inline text-blue-300/40">
              |
            </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
              ...
              return (
                <a
                  ...
                  className={`px-3 py-2 rounded-lg text-sm font-semibold transition-colors duration-150 whitespace-nowrap ${
                    isActive
                      ? 'text-[#FF6B00] bg-orange-50 font-bold border-b-2 border-[#FF6B00]'
          ...
          <div className="hidden sm:flex items-center gap-3">
            <button
              ...
              type="button"
              className="text-xs font-bold text-[#072B57] hover:text-[#FF6B00] px-3.5 py-2 rounded-lg border border-slate-200 hover:border-slate-300 transition-colors cursor-pointer"
            >
              Brochure
            </button>
            ...
            <button
              ...
              id="header-apply-btn"
              type="button"
              className="inline-flex items-center justify-center gap-2 bg-[#FF6B00] hover:bg-[#e05e00] text-white font-bold text-sm px-5 py-2.5 rounded-xl shadow-sm hover:shadow transition-all duration-150 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#FF6B00] focus:ring-offset-2"
            >
              <span>Apply Now</span>
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              onClick={() => onOpenApply()}
              type="button"
              className="sm:hidden bg-[#FF6B00] text-white text-xs font-bold px-3 py-1.5 rounded-lg cursor-pointer"
            >
              Apply
            </button>
            ...
            <button
              ...
              className="p-2 rounded-xl text-slate-700 hover:text-[#072B57] hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-[#FF6B00]"
            >
              {mobileMenuOpen ? (
                <X className="w-6 h-6" />
              ) : (
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="py-2 border-b border-slate-100">
              <CbmLogo variant="light" height={38} showTagline={true} />
            </div>
                ...
                return (
                  <a
                    ...
                    className={`px-3 py-2.5 rounded-lg text-base font-semibold transition-colors flex items-center justify-between ${
                      isActive
                        ? 'text-[#FF6B00] bg-orange-50 font-bold border-l-4 border-[#FF6B00]'
                        : 'text-slate-600 hover:text-[#072B57] hover:bg-slate-50'
                    }`}
                  >
                    <span>{link.name}</span>
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-col gap-2">
              <button
                ...
                type="button"
                className="w-full text-center py-2.5 rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 font-bold text-sm"
              >
              ...
              <button
                ...
                type="button"
                className="w-full inline-flex items-center justify-center gap-2 bg-[#FF6B00] hover:bg-[#e05e00] text-white font-bold text-base py-3 rounded-xl shadow-md"
              >
